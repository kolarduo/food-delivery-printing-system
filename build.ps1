...
$stageDir = Join-Path $env:TEMP 'FoodDeliveryPrintingSystem-stage-0.1.1'
$payloadFile = Join-Path $env:TEMP 'FoodDeliveryPrintingSystem-payload-0.1.1.zip'
$outputDir = Join-Path $projectDir 'dist'
$outputExe = Join-Path $outputDir 'FoodDeliveryPrintingSystem-0.1.1.exe'
